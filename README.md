...
1. download [pngpal2raw](https://github.com/swfans/pngpal2raw/releases/),
   place the binary in `syndicatfx-gfx/bin` or any folder included in `PATH` env var.
2. go into the directory with `syndicatfx-gfx` source release
...
6. do `make install` to copy the files into `syndicatfx` installation folder
...
That's all. See more documentation in [SyndicatFX repo](https://github.com/swfans/syndicatfx).
